...
module design_1_text_0_0(clk, reset, pixel_x, pixel_y, score_dig3, 
  score_dig2, score_dig1, score_dig0, lives, text_on, text_rgb, rom_addr, rom_data)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,pixel_x[9:0],pixel_y[9:0],score_dig3[3:0],score_dig2[3:0],score_dig1[3:0],score_dig0[3:0],lives[2:0],text_on[3:0],text_rgb[2:0],rom_addr[10:0],rom_data[7:0]" */;
  input clk;
  input reset;
  input [9:0]pixel_x;
  input [9:0]pixel_y;
