...
proc create_root_design { parentCell } {
  ...
  set ps2_rx_enable [ create_bd_port -dir O ps2_rx_enable ]
  set ps2_tx_idle [ create_bd_port -dir O ps2_tx_idle ]
  ...
  connect_bd_net -net input_controller_0_ps2_rx_enable [get_bd_ports ps2_rx_enable] [get_bd_pins input_controller_0/ps2_rx_enable] [get_bd_pins ps2_rx_0/enable]
  ...
  connect_bd_net -net ps2_tx_0_idle [get_bd_ports ps2_tx_idle] [get_bd_pins input_controller_0/ps2_tx_idle] [get_bd_pins ps2_tx_0/idle]
